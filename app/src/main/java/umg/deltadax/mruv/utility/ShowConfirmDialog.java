...
public class ShowConfirmDialog {
     ...
     * @param message         mensaje o pregunta
     * @param BotonNo         titulo para el boton No
     * @param BotonSi         titulo para el boton Si
     * @param listenerBotonSi evento a realizar en caso el boton si es precionado
     */
